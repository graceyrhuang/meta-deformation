...
def parser():
    ...
    parser.add_argument('--start_epoch', type=int, default=66, help='number of epochs to train for')
    ...
    parser.add_argument('--dataset_path', type=str, default = './data/MPI-FAUST/test/scans/',  help='inference dataset')
    parser.add_argument('--dir_name', type=str, default="./log/6_layer_with_bn/",  help='saving trained model to')

    # Network
    parser.add_argument('--model', type=str, default="./log/6_layer_with_bn/network.pth", help='optional reload model path')
    ...
    parser.add_argument('--template_mode', type=str, default="TEMPLATE", choices=["TEMPLATE, SOUP, TRAINDATA, SPHERE"] ,help='dim_out_patch')
    ...
    # Eval parameters
    parser.add_argument('--HR', type=int, default=0, help='Use high Resolution template')
